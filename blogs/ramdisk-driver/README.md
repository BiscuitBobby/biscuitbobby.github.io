...
6.  **Use:** Now you can read/write files in `/mnt/ramdisk`!
	```bash
	root@syzkaller:/mnt/ramdisk$ ls
	lost+found
	root@syzkaller:/mnt/ramdisk$ echo "Lemon" >> test.txt
	root@syzkaller:/mnt/ramdisk$ cat test.txt 
	Lemon
	```
...
Here is the source code to the driver: https://github.com/BiscuitBobby/kernel_drivers/blob/main/simple_block/block_simp.c
